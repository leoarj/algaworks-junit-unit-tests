...
/**
 * Exemplo de classe de testes com combinação de @Nested, @BeforeEach e nomenclatura BDD.
 *
 * Cada cenário é uma classe, com sub-cenários aninhados (classes) onde são descritos os testes para cada qual.
 * Esse tipo de organização é mais orientado a POO.
 * */
